...
user_pref("app.update.lastUpdateTime.browser-cleanup-thumbnails", 1678560662);
user_pref("app.update.lastUpdateTime.region-update-timer", 0);
user_pref("app.update.lastUpdateTime.search-engine-update-timer", 1678561161);
user_pref("app.update.lastUpdateTime.services-settings-poll-changes", 1678562828);
user_pref("app.update.lastUpdateTime.xpi-signature-verification", 0);
user_pref("app.update.migrated.updateDir3.DD698066581A321D", true);
...
user_pref("browser.contextual-services.contextId", "{d5a37ce3-6c55-4f71-b1b7-e0bd61ef53f0}");
...
user_pref("browser.newtabpage.activity-stream.impressionId", "{34a395d3-d056-445b-987f-e20654569736}");
...
user_pref("browser.region.update.updated", 1678560633);
...
user_pref("browser.sessionstore.upgradeBackup.latestBuildID", "20230114051534");
user_pref("browser.shell.checkDefaultBrowser", false);
user_pref("browser.startup.couldRestoreSession.count", 2);
user_pref("browser.startup.homepage", "about:blank");
user_pref("browser.startup.homepage_override.mstone", "ignore");
user_pref("browser.startup.lastColdStartupCheck", 1678563733);
...
user_pref("browser.uiCustomization.state", "{\"placements\":{\"widget-overflow-fixed-list\":[],\"unified-extensions-area\":[],\"nav-bar\":[\"back-button\",\"forward-button\",\"stop-reload-button\",\"customizableui-special-spring1\",\"urlbar-container\",\"customizableui-special-spring2\",\"save-to-pocket-button\",\"downloads-button\",\"fxa-toolbar-menu-button\",\"_d10d0bf8-f5b5-c8b4-a8b2-2b9879e08c5d_-browser-action\",\"ublock0_raymondhill_net-browser-action\"],\"toolbar-menubar\":[\"menubar-items\"],\"TabsToolbar\":[\"tabbrowser-tabs\",\"new-tab-button\",\"alltabs-button\"],\"PersonalToolbar\":[\"import-button\",\"personal-bookmarks\"]},\"seen\":[\"save-to-pocket-button\",\"developer-button\",\"_d10d0bf8-f5b5-c8b4-a8b2-2b9879e08c5d_-browser-action\",\"ublock0_raymondhill_net-browser-action\"],\"dirtyAreaCache\":[\"nav-bar\",\"PersonalToolbar\",\"toolbar-menubar\",\"TabsToolbar\"],\"currentVersion\":18,\"newElementCount\":2}");
...
user_pref("extensions.lastAppBuildId", "20230114051534");
...
user_pref("extensions.webextensions.uuids", "{\"formautofill@mozilla.org\":\"ec21da23-5c53-47a3-8bd7-496972958ccf\",\"pictureinpicture@mozilla.org\":\"fb17e373-b93d-440d-93f2-7ae919029ad0\",\"screenshots@mozilla.org\":\"185920a2-9882-4dde-bcf2-d7506eef50f4\",\"webcompat-reporter@mozilla.org\":\"2703bccc-7e61-440c-9da8-d578de1c0348\",\"webcompat@mozilla.org\":\"db8f4d80-1a97-4e96-93f2-d8849ea5ad60\",\"default-theme@mozilla.org\":\"2b4007e8-c930-46a7-a7c7-fbe41b4656fb\",\"addons-search-detection@mozilla.com\":\"c8971e55-3198-4420-8998-b88810bbc043\",\"google@search.mozilla.org\":\"afdbdda1-5491-4b0d-8a6e-b864ce850785\",\"wikipedia@search.mozilla.org\":\"64b0f3e5-e1b1-4f24-a0f4-5527932fcdab\",\"bing@search.mozilla.org\":\"e61778f5-afa2-4031-b296-ee98fb8f2f03\",\"amazon@search.mozilla.org\":\"d47b03b1-d54b-47a6-aad6-0efa5a8d65f7\",\"ddg@search.mozilla.org\":\"dfca3ace-6655-4522-b0a7-f9e66b069f8e\",\"{d10d0bf8-f5b5-c8b4-a8b2-2b9879e08c5d}\":\"becc58a0-15e5-4dfc-86b0-9c6ce56e0f19\",\"uBlock0@raymondhill.net\":\"23ad3fbe-b34e-4d25-9e08-1ba67249f3a7\"}");
user_pref("extensions.webservice.discoverURL", "");
user_pref("fission.bfcacheInParent", false);
user_pref("fission.experiment.max-origins.last-disqualified", 0);
user_pref("fission.experiment.max-origins.last-qualified", 1678560634);
...
user_pref("gfx-shader-check.build-version", "20230114051534");
user_pref("gfx-shader-check.device-id", "0x1b80");
user_pref("gfx-shader-check.driver-version", "31.0.15.2802");
...
user_pref("sanity-test.driver-version", "31.0.15.2802");
user_pref("sanity-test.running", false);
user_pref("sanity-test.version", "20230114051534");
user_pref("security.certerrors.mitm.priming.enabled", false);
user_pref("security.fileuri.strict_origin_policy", false);
user_pref("security.notification_enable_delay", 0);
user_pref("security.sandbox.content.level", 2);
user_pref("security.sandbox.content.tempDirSuffix", "{0d466af9-2aee-4faa-8c29-840bc39978a0}");
...
user_pref("toolkit.startup.last_success", 1678563732);
user_pref("toolkit.startup.max_resumed_crashes", -1);
user_pref("toolkit.telemetry.cachedClientID", "c0ffeec0-ffee-c0ff-eec0-ffeec0ffeec0");
user_pref("toolkit.telemetry.enabled", false);
user_pref("toolkit.telemetry.previousBuildID", "20230114051534");
